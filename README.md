...
Use nam_a2lite_header.html to convert an existing A2 model .nam file (full + lite) into the extracted 3ch weights array .h file that be used directly by the Teensy. 
